...
static OfflinePunctuationConfig GetOfflinePunctuationConfig(JNIEnv *env,
  ...
  fid = env->GetFieldID(
      cls, "model", "Lcom/giongnoiai/tts/engine/OfflinePunctuationModelConfig;");
...
Java_com_giongnoiai_tts_engine_OfflinePunctuation_newFromAsset(
...
SHERPA_ONNX_EXTERN_C
JNIEXPORT jlong JNICALL
Java_com_giongnoiai_tts_engine_OfflinePunctuation_newFromFile(JNIEnv *env,
                                                          jobject /*obj*/,
                                                          jobject _config) {
  bool ok = false;
  auto config = sherpa_onnx::GetOfflinePunctuationConfig(env, _config, &ok);
...
SHERPA_ONNX_EXTERN_C
JNIEXPORT void JNICALL Java_com_giongnoiai_tts_engine_OfflinePunctuation_delete(
...
Java_com_giongnoiai_tts_engine_OfflinePunctuation_addPunctuation(JNIEnv *env,
                                                             jobject /*obj*/,
                                                             jlong ptr,
                                                             jstring text) {
